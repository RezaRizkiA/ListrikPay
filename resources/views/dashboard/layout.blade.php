            ...
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('dashboard.index') }}"
                        class="flex items-center p-2 text-base font-medium {{ request()->routeIs('dashboard.index') ? 'bg-gray-700 text-white' : 'text-gray-900' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="{{ route('dashboard.pelanggan') }}"
                        class="flex items-center p-2 text-base font-medium {{ request()->routeIs('dashboard.pelanggan') ? 'bg-gray-700 text-white' : 'text-gray-900' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                ...
                <li>
                    <a href="{{ route('dashboard.penggunaan') }}"
                        class="flex items-center p-2 text-base font-medium {{ request()->routeIs('dashboard.penggunaan') ? 'bg-gray-700 text-white' : 'text-gray-900' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                        ...
                        <span class="ml-3">Penggunaan Listrik</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('dashboard.tagihan') }}"
                        class="flex items-center p-2 text-base font-medium {{ request()->routeIs('dashboard.tagihan') ? 'bg-gray-700 text-white' : 'text-gray-900' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                ...
                <li>
                    <a href="{{ route('dashboard.pembayaran') }}"
                        class="flex items-center p-2 text-base font-medium {{ request()->routeIs('dashboard.pembayaran') ? 'bg-gray-700 text-white' : 'text-gray-900' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                ...
                <li>
                    <a href="{{ route('dashboard.tarif') }}"
                        class="flex items-center p-2 text-base font-medium {{ request()->routeIs('dashboard.tarif') ? 'bg-gray-700 text-white' : 'text-gray-900' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
