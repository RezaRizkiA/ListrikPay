                    ...
                    <div class="mb-4">
                        ...
                        <dd class="mb-4 space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">{{ $data['id'] }}</span>
                            </div>
                            <div class="flex justify-between">
                        ...
                        <dd class="mb-4 space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-semibold text-gray-900 dark:text-white">Rp{{ number_format($data['tagihan_listrik']) }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-gray-400">Biaya Admin</span>
                                <span
                                    class="text-gray-900 dark:text-white">Rp{{ number_format($data['biaya_admin']) }}</span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between border-t pt-2 mt-2">
                                ...
                                <span class="text-lg font-bold text-primary-700 dark:text-primary-400">
                                    Rp{{ number_format($data['tagihan_listrik'] + $data['biaya_admin'] + $data['ppn']) }}
                                </span>
                            </div>
                        </dd>
                    </div>
